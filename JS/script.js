...
function loadCpage(){
    formConfirmedPbox.innerHTML=`<div class="flex-content"><div class="content"><img src="images/icon-complete.svg" alt="Check Mark" class="icon-compconste"><h1>THANK YOU!</h1><p>We've added your card details</p><input type="button" id="btn-continue" value="Continue"></div></div>`
}
